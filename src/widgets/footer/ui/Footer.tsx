  ...
  return (
    <footer className="py-5" style={{ backgroundColor: 'var(--color-text)', color: 'var(--color-secondary)' }}>
      <div className="container">
        <div className="row gy-4">
          ...
          <div className="col-lg-2 col-6">
            ...
            <ul className="list-unstyled">
              <li>
                <Link href="/courses" className="text-decoration-none" style={{ color: 'rgba(244, 241, 234, 0.7)' }}>
                  {t.nav.courses}
                </Link>
              </li>
              <li>
                <Link href="/tours" className="text-decoration-none" style={{ color: 'rgba(244, 241, 234, 0.7)' }}>
                  {t.nav.tours}
                </Link>
              </li>
              <li>
          ...
          <div className="col-lg-2 col-6">
            ...
            <ul className="list-unstyled">
              <li>
                <Link href="/about" className="text-decoration-none" style={{ color: 'rgba(244, 241, 234, 0.7)' }}>
                  {t.nav.about}
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-decoration-none" style={{ color: 'rgba(244, 241, 234, 0.7)' }}>
                  {t.nav.contact}
                </Link>
              </li>
              <li>
        ...
        <div
          className="border-top mt-5 pt-4 d-flex flex-column flex-md-row justify-content-between align-items-center"
          style={{ borderColor: 'rgba(244, 241, 234, 0.2) !important', color: 'rgba(244, 241, 234, 0.5)' }}
        >
          <small className="mb-2 mb-md-0">
            © {new Date().getFullYear()} YOGA.LIFE. {t.footer.rights}
          </small>
          <div className="d-flex gap-3">
            <Link
              href="/privacy"
              className="text-decoration-none"
              style={{ color: 'rgba(244, 241, 234, 0.5)', fontSize: '0.875em' }}
            >
