            ...
            <Link href="/courses-beginners" className="text-decoration-none">
              <div className="card h-100 border-0 text-white overflow-hidden position-relative group-hover" style={{ minHeight: '400px', borderRadius: '20px' }}>
                ...
                <div className="card-img-overlay d-flex flex-column justify-content-end p-4 z-2" style={{ background: WARM_OVERLAY }}>
                  <span className="badge rounded-pill mb-2 align-self-start" style={{ backgroundColor: 'var(--color-accent)', color: '#fff', fontSize: '0.75rem' }}>{t.home.course1Badge}</span>
          ...
          <div className="col-md-6 col-lg-3 reveal-up reveal-delay-1" ref={observe as any}>
            <Link href="/courses-meditation" className="text-decoration-none">
              <div className="card h-100 border-0 text-white overflow-hidden position-relative group-hover" style={{ minHeight: '400px', borderRadius: '20px' }}>
                ...
                />
                <div className="card-img-overlay d-flex flex-column justify-content-end p-4 z-2" style={{ background: WARM_OVERLAY }}>
                  <span className="badge rounded-pill mb-2 align-self-start" style={{ backgroundColor: 'var(--color-accent)', color: '#fff', fontSize: '0.75rem' }}>{t.home.course2Badge}</span>
          ...
          <div className="col-md-6 col-lg-3 reveal-up reveal-delay-2" ref={observe as any}>
            <Link href="/courses-back" className="text-decoration-none">
              <div className="card h-100 border-0 text-white overflow-hidden position-relative group-hover" style={{ minHeight: '400px', borderRadius: '20px' }}>
                ...
                />
                <div className="card-img-overlay d-flex flex-column justify-content-end p-4 z-2" style={{ background: WARM_OVERLAY }}>
                  <span className="badge rounded-pill mb-2 align-self-start" style={{ backgroundColor: 'var(--color-accent)', color: '#fff', fontSize: '0.75rem' }}>{t.home.course3Badge}</span>
          ...
          <div className="col-md-6 col-lg-3 reveal-up reveal-delay-3" ref={observe as any}>
            <Link href="/courses-women" className="text-decoration-none">
              <div className="card h-100 border-0 text-white overflow-hidden position-relative group-hover" style={{ minHeight: '400px', borderRadius: '20px' }}>
                ...
                />
                <div className="card-img-overlay d-flex flex-column justify-content-end p-4 z-2" style={{ background: WARM_OVERLAY }}>
                  <span className="badge rounded-pill mb-2 align-self-start" style={{ backgroundColor: 'var(--color-accent)', color: '#fff', fontSize: '0.75rem' }}>{t.home.course4Badge}</span>
