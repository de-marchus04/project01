    ...
    <main>
      ...
      <section className="py-5" style={{ backgroundColor: 'var(--color-bg)' }}>
        <div className="container py-5">
          <SectionHeader badge={t.programs.consultDiet} title={t.programs.availablePrograms} observe={observe} />
