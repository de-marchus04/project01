    ...
    <main>
      <section
        ...
        style={{
          ...
          minHeight: '400px',
          background:
            "linear-gradient(rgba(62, 66, 58, 0.6), rgba(62, 66, 58, 0.7)), url('https://images.unsplash.com/photo-1575052814086-f385e2e2ad1b?q=80&w=2070&auto=format&fit=crop') center/cover",
        }}
      >
        <HeroSlider
          pageKey="blog-videos"
        ...
        <div className="container position-relative z-2">
          ...
          <p className="lead text-white-50">{tStr('Практикуйте вместе с нами в любом месте')}</p>
        </div>
      </section>
            ...
            <div className="modal-content border-0 rounded-4 overflow-hidden">
              ...
              <div className="modal-body p-4 pt-0">
                ...
                <div className="ratio ratio-16x9 mb-4 rounded-4 overflow-hidden shadow-sm">
                  <iframe
                    src={withRelZero(selectedVideo.videoUrl)}
                    title={tStr(selectedVideo.title)}
                    allowFullScreen
                  ></iframe>
                </div>
