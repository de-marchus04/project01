    ...
    <main>
      ...
      >
        ...
        <div className="container position-relative z-2">
          ...
          <p className="lead text-white-50">{tStr('Вкусная и полезная еда для вашего тела')}</p>
        </div>
      </section>
                  ...
                  <div className="modal-body p-4 p-md-5">
                    <div className="mb-3">
                      <span className="badge bg-light text-dark border mb-2">
                        {selectedRecipe.tag || tStr('Рецепт')}
                      </span>
                      <span
                        className="badge text-white rounded-pill ms-2 mb-2"
