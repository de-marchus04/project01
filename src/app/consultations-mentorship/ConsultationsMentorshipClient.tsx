...
export default function ConsultationsMentorshipClient({ initialData }: { initialData: any }) {
  ...
  return (
    <main>
      ...
      >
        <HeroSlider pageKey="consultations-mentorship" images={[
        ...
        <div className="container position-relative z-2">
          <span className="text-uppercase ls-2 mb-3 d-block small fw-bold" style={{ color: 'var(--color-secondary)' }}>{t.programs.consultMentor}</span>
          <h1 className="display-3 font-playfair mb-4" style={{ textShadow: '0 4px 15px rgba(0,0,0,0.2)' }}>{t.programs.consultNum}</h1>
          <p className="lead mb-5 col-lg-8 mx-auto fw-light">{t.programs.consultMentorDesc}</p>
        </div>
      </section>
      ...
      <section className="py-5" style={{ backgroundColor: 'var(--color-bg)' }}>
        <div className="container py-5">
          <SectionHeader
            badge={t.programs.consultMentor}
