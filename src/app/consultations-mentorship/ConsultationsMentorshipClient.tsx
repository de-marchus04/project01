...
export default function ConsultationsMentorshipClient({ initialData }: { initialData: any }) {
  ...
  return (
    <main>
      ...
      >
        <HeroSlider pageKey="consultations-mentorship" />
      ...
      <section className="py-5" style={{ backgroundColor: 'var(--color-bg)' }}>
        <div className="container py-5">
          <SectionHeader badge={t.programs.consultMentor} title={t.programs.availablePrograms} observe={observe} />
