              ...
              <div className="text-center mb-4">
                {user.photo && (user.photo.startsWith('http') || user.photo.startsWith('data:image')) ? (
                  <Image
                    ...
                    className="mb-3"
                    style={{ objectFit: 'cover', borderRadius: '50%', border: '3px solid var(--color-primary)', display: 'block', margin: '0 auto 12px' }}
                  />
                ) : (
                  ...
                  <div className="rounded-4 shadow-sm p-4" style={cardBg}>
                    ...
                    <div className="row g-4">
                      <div className="col-12 d-flex align-items-center gap-4 mb-2">
                        {user.photo ? (
                          <Image width={100} height={100} src={user.photo || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=100'} style={{ objectFit: 'cover', borderRadius: '50%', border: '2px solid var(--color-border)' }} alt="Profile" />
                        ) : (
