            ...
            <div className="col-12 col-lg-8">
              ...
              >
                <p style={{ color: 'var(--color-text)', lineHeight: 1.8 }}>
                  YOGA.LIFE поважає вашу приватність і зобов&apos;язується захищати персональні дані, які ви нам довіряєте.
                  Ця Політика конфіденційності описує, яку інформацію ми збираємо, як її використовуємо та які заходи
                  вживаємо для її захисту.
                </p>
              </div>
