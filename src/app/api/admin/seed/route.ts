...
export async function POST(request: Request) {
  ...
  const faqs = [
    ...
    {
      question: 'Как долго сохраняется доступ к курсам?',
      answer:
  ...
  const testimonials = [
    {
      ...
      text: 'Никогда не думала, что смогу заниматься йогой. Анна объясняет так понятно, что уже через неделю почувствовала разницу. Теперь практикую каждое утро уже 4 месяца!',
    },
    {
      name: 'Олег Стецюк',
      course: 'Здоровая спина',
      text: 'Три года мучился с болями в пояснице. После 4-недельной программы боли ушли примерно на 80%. Теперь делаю комплекс каждое утро.',
    },
    {
      name: 'Светлана Бондаренко',
      course: 'Йога-ретрит на Бали',
      text: 'Ретрит на Бали — лучшее что произошло со мной в этом году. Уехала уставшей мамой-менеджером, вернулась другим человеком. Организация на высшем уровне.',
    },
    {
      name: 'Татьяна Коваль',
      course: 'Медитация для занятых',
      text: 'Я скептически относилась к медитации. После 3 недель заметила, что стала спокойнее реагировать на стресс на работе. Коллеги спрашивают что случилось 😄',
    },
    {
      name: 'Марина Иванченко',
      course: 'Женская йога',
      text: 'Наконец-то нашла то, что искала. Гормональный фон выровнялся, стала лучше спать. Рекомендую всем женщинам без исключения.',
    },
  ];
