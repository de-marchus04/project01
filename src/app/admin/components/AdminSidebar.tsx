    ...
    <>
      ...
      >
        ...
        >
          {/* Logo */}
          <div
            className="d-flex align-items-center gap-2 mb-3 pb-3"
          ...
          >
            ...
            <div>
              <div
                className="font-playfair fw-bold"
                style={{ fontSize: '1rem', color: 'var(--color-text)', lineHeight: 1.2 }}
              >
                YOGA.LIFE
              </div>
              <div
          ...
          <div className="mb-3">
            <span
              className="d-block text-center py-2 rounded-3"
              style={{
                fontSize: '0.8rem',
                fontWeight: 600,
                backgroundColor: isProfileSaved
                  ? 'rgba(25,135,84,0.1)'
                  : isProfileEdited
                    ? 'rgba(255,193,7,0.15)'
                    : 'var(--color-secondary)',
          ...
          <div className="row g-2 mb-3">
            <div className="col-6">
              ...
              >
                <div className="fw-bold" style={{ fontSize: '0.95rem', color: 'var(--color-primary)' }}>
                  {formatPrice(stats.earnedTotal, lang)}
                </div>
                <div
                  style={{
                    fontSize: '0.65rem',
            ...
            <div className="col-12">
              <div
                ...
                style={{ backgroundColor: 'var(--color-secondary)', border: '1px solid var(--color-border)' }}
              >
                <div className="fw-bold text-truncate" style={{ fontSize: '0.8rem', color: 'var(--color-primary)' }}>
          ...
          <nav className="d-flex flex-column gap-1">
            {TABS.map(([pane, label, icon]) => (
              <div
                ...
                onMouseEnter={(e) => {
                  if (activeTab !== pane) e.currentTarget.style.backgroundColor = 'var(--color-secondary)';
                }}
                onMouseLeave={(e) => {
                  if (activeTab !== pane) e.currentTarget.style.backgroundColor = 'transparent';
                }}
              >
