      ...
      <form onSubmit={handleSave}>
        <div className="row g-3">
          <div className="col-12">
            <h6 className="fw-semibold text-muted text-uppercase small mb-3" style={{ letterSpacing: '1px' }}>
              {t.admin.settingsContactSection}
            </h6>
          </div>
          <div className="col-md-6">
            <label className="form-label small fw-semibold" style={{ color: 'var(--color-text-muted)' }}>
              {t.admin.settingsAddress}
            </label>
            <input
              type="text"
          ...
          <div className="col-md-6">
            ...
            <input
              ...
              placeholder="contact@yoga.life"
            />
          </div>
          <div className="col-md-6">
            <label className="form-label small fw-semibold" style={{ color: 'var(--color-text-muted)' }}>
              {t.admin.settingsPhone}
            </label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="col-12 mt-2">
            <h6 className="fw-semibold text-muted text-uppercase small mb-3" style={{ letterSpacing: '1px' }}>
              {t.admin.settingsAboutSection}
            </h6>
          </div>
          <div className="col-md-6">
            <label className="form-label small fw-semibold" style={{ color: 'var(--color-text-muted)' }}>
              {t.admin.settingsYearsExp}
            </label>
            <input
              type="text"
              className="form-control"
