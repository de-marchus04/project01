    ...
    <main>
      <section
        ...
        style={{
          ...
          minHeight: '400px',
          background:
            "linear-gradient(rgba(62, 66, 58, 0.6), rgba(62, 66, 58, 0.7)), url('https://images.unsplash.com/photo-1478737270239-2f02b77fc618?q=80&w=2070&auto=format&fit=crop') center/cover",
        }}
      >
        <HeroSlider
          pageKey="blog-podcasts"
          images={[
        ...
        <div className="container position-relative z-2">
          ...
          <p className="lead text-white-50">{tStr('Слушайте нас в дороге, на прогулке или дома')}</p>
        </div>
      </section>
            ...
            <div className="modal-content border-0 rounded-4 overflow-hidden">
              ...
              <div className="modal-body p-4 pt-0 text-center">
                <div
                  ...
                  style={{ width: '100px', height: '100px', backgroundColor: 'var(--color-primary)' }}
                >
                ...
                <div className="mb-3">
                  ...
                  <span className="badge bg-light text-dark border ms-2 mb-2">
                ...
                <div className="bg-light rounded-pill p-2 d-flex align-items-center gap-3">
                  <button
                    className="btn btn-dark rounded-circle p-0 d-flex align-items-center justify-content-center flex-shrink-0"
