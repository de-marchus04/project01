        ...
        <div className="container py-5">
          <div className="row align-items-center g-5">
            <div className="col-lg-6 reveal-up" ref={observe as any}>
              <div
                className="badge text-uppercase px-3 py-2 mb-3 rounded-pill"
                style={{
                  backgroundColor: 'rgba(140, 154, 129, 0.1)',
              ...
              <h1 className="display-4 font-playfair fw-bold mb-4" style={{ color: 'var(--color-text)' }}>
                {t.home.aboutTitle.split(' ').slice(0, 3).join(' ')} <br />
                {t.home.aboutTitle.split(' ').slice(3).join(' ')}
              </h1>
              ...
              <div className="row g-4 mt-2">
                <div className="col-6">
                  <h3 className="display-5 fw-bold mb-0" style={{ color: 'var(--color-primary)' }}>
                    {yearsExp}
                  </h3>
                  <p className="fw-medium" style={{ color: 'var(--color-text-muted)' }}>
                    {t.home.yearsExp}
                  </p>
                </div>
                <div className="col-6">
            ...
            <div className="col-lg-6 reveal-up reveal-delay-1" ref={observe as any}>
              <div className="position-relative">
                ...
                ></div>
                <div className="position-relative rounded-4 shadow-lg" style={{ height: '600px', zIndex: 1 }}>
                  <Image
          ...
          <div className="row g-4">
            {[
              ...
              <div className={`col-md-6 col-lg-3 reveal-up reveal-delay-${i % 4}`} key={i} ref={observe as any}>
                <div
                  className="card border-0 h-100 text-center p-4 rounded-4"
                  style={{ backgroundColor: 'var(--color-bg)', transition: 'transform 0.3s ease' }}
                  onMouseEnter={(e) => (e.currentTarget.style.transform = 'translateY(-10px)')}
                  onMouseLeave={(e) => (e.currentTarget.style.transform = 'translateY(0)')}
                >
                  <div
                    className="d-inline-flex align-items-center justify-content-center rounded-circle mb-4 mx-auto"
                    style={{ width: '80px', height: '80px', backgroundColor: 'rgba(140, 154, 129, 0.1)' }}
                  >
                    <i className={`bi ${val.icon} fs-1`} style={{ color: 'var(--color-primary)' }}></i>
                  </div>
                  <h4 className="h5 fw-bold mb-3" style={{ color: 'var(--color-text)' }}>
                    {val.title}
                  </h4>
            ...
            {(teamMembers.length > 0
              ...
              <div className={`col-md-4 reveal-up reveal-delay-${i}`} key={i} ref={observe as any}>
                <div className="card border-0 rounded-4 overflow-hidden shadow-sm h-100">
                  <div className="overflow-hidden rounded-top" style={{ position: 'relative', height: '350px' }}>
                    <Image
                      src={member.img}
                      fill
                  ...
                  <div className="card-body text-center p-4" style={{ backgroundColor: 'var(--color-surface)' }}>
                    <h4 className="h5 fw-bold mb-1" style={{ color: 'var(--color-text)' }}>
                      {member.name}
                    </h4>
                    <p className="small mb-0" style={{ color: 'var(--color-primary)' }}>
                      {member.role}
                    </p>
                  </div>
                </div>
            ...
            <div className="row g-0">
              <div className="col-lg-8 p-5 d-flex flex-column justify-content-center">
                ...
                <p className="lead text-white mb-4" style={{ opacity: 0.9 }}>
                  {tStr('Присоединяйтесь к нашему сообществу и откройте для себя мир гармонии и здоровья.')}
                </p>
                <div>
                  <Link
                    href="/courses"
                    className="btn btn-light rounded-pill px-5 py-3 fw-bold me-3 mb-3 mb-md-0"
                    style={{ color: 'var(--color-primary)' }}
                  >
                    {t.home.joinBtn}
                  </Link>
                  <Link href="/contact" className="btn btn-outline-light rounded-pill px-5 py-3 fw-bold">
                    {tStr('Связаться с нами')}
                  </Link>
                </div>
              </div>
              <div
