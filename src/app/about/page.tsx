  ...
  return (
    <main className="min-vh-100 pt-5" style={{ backgroundColor: 'var(--color-bg)' }}>
      ...
      <section className="py-5" style={{ backgroundColor: 'var(--color-surface)' }}>
        <div className="container py-5">
          <div className="text-center mb-5">
            ...
            <p className="lead" style={{ color: 'var(--color-text-muted)' }}>{t.home.valuesSubtitle}</p>
          </div>
      ...
      <section className="py-5">
        <div className="container py-5">
          <div className="text-center mb-5">
            <h2 className="h2 font-playfair fw-bold mb-3" style={{ color: 'var(--color-text)' }}>{t.home.teamTitle}</h2>
            <p className="lead" style={{ color: 'var(--color-text-muted)' }}>{t.home.teamSubtitle}</p>
          </div>
