              ...
              <div className="card shadow-lg overflow-hidden" style={{ background: cardBg, backdropFilter: 'blur(10px)', border: '1px solid rgba(140, 154, 129, 0.2)', borderRadius: '24px' }}>
                <div className="card-body p-5">
                  ...
                  <div className="text-center mt-4 pt-3" style={{ borderTop: '1px solid var(--color-border)' }}>
                    <a href="/login" className="btn btn-link text-decoration-none" style={{ color: 'var(--color-text-muted)' }}>
                      Вернуться ко входу
                    </a>
                  </div>
                </div>
...
export default function ResetPasswordClient() {
  return (
    <Suspense fallback={<div className="d-flex justify-content-center align-items-center" style={{ minHeight: '100vh' }}><div className="spinner-border text-primary" role="status"></div></div>}>
      <ResetPasswordForm />
    </Suspense>
  );
}
