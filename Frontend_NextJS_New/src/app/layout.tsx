    ...
    <html lang="ru" suppressHydrationWarning>
      ...
      <body className={`${montserrat.variable} ${playfair.variable}`}>
        <LanguageProvider>
          ...
          <div id="main-content" style={{ transition: 'transform var(--duration-slow) var(--ease-out)', minHeight: '100vh', backgroundColor: 'var(--color-bg-elevated)', position: 'relative', zIndex: 1, boxShadow: 'var(--shadow-md)' }}>
            <Header />
            <LockoutTimer />
            <GlobalModal />
            <SupportWidget />
