...
export default function CoursesMeditationClient({ initialData }: { initialData: any }) {
  const { t } = useLanguage();
  ...
  useEffect(() => {
    ...
    async function loadProducts() {
      try {
        const data = await getMeditationCourses();
        setProducts(data);
      } catch (err) {
  ...
  return (
    <main>
      ...
      >
          <HeroSlider images={["https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=2070&auto=format&fit=crop","https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=2020&auto=format&fit=crop","https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?q=80&w=2000&auto=format&fit=crop","https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=2000&auto=format&fit=crop","https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&w=2000&auto=format&fit=crop"]} /> 
