...
export default function CoursesBeginnersClient({ initialData }: { initialData: PaginatedResponse<Course> }) {
  ...
  useEffect(() => {
    if (isInitialLoad) {
      ...
      return; // Пропускаем первый рендер, так как данные уже есть из SSR
    }
    ...
    async function loadProducts() {
      ...
      try {
        ...
        setError(t.programs.errLoad + ' : ' + (err as Error).message);
      } finally {
        setLoading(false);
      }
    }
  ...
  return (
    <main>
      ...
      >
          <HeroSlider images={["https://images.unsplash.com/photo-1599447421405-0753f5d1a5ca?q=80&w=2070&auto=format&fit=crop","https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=2020&auto=format&fit=crop","https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?q=80&w=2000&auto=format&fit=crop","https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=2000&auto=format&fit=crop","https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&w=2000&auto=format&fit=crop"]} />
