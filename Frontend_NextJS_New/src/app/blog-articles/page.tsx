    ...
    <main>
      ...
      <section 
        ...
        style={{
            height: '50vh',
            minHeight: '400px',
            background: "linear-gradient(rgba(62, 66, 58, 0.6), rgba(62, 66, 58, 0.7)), url('https://images.unsplash.com/photo-1544367563-12123d8965bf?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80') center/cover"
        }}
      >
          <HeroSlider images={["https://images.unsplash.com/photo-1544367563-12123d8965bf?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80","https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=2020&auto=format&fit=crop","https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?q=80&w=2000&auto=format&fit=crop","https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=2000&auto=format&fit=crop","https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&w=2000&auto=format&fit=crop"]} />
          <div className="container position-relative z-2">
              <h1 className="display-3 font-playfair mb-4" style={{ textShadow: '0 4px 15px rgba(0,0,0,0.2)' }}>{tStr("Наш Блог")}</h1>
              <p className="lead text-white-50">
                  {tStr("Полезные материалы для вашей практики")}
              </p>
          </div>
      </section>
      ...
      <section id="articles-content" className="py-5 bg-light">
          <div className="container py-5">
              ...
              <div className="row g-4">
                  ...
                  {error && (
                      <div className="col-12 alert alert-warning text-center">{error}</div>
                  )}
                  ...
                  {!loading && !error && articles.map(article => (
                      <div key={article.id} className="col-md-6 col-lg-4" onClick={() => setSelectedArticle(article)} style={{ cursor: 'pointer' }}>
