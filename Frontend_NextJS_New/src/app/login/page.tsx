                ...
                <div className="card-body p-5">
                  ...
                  <div className="text-center mt-4 pt-3 border-top">
                    <button 
                      ...
                      disabled={loading}
                    >
                      {isRegisterMode ? ((t as any).auth ? (t as any).auth.linkToLogin : 'Уже есть аккаунт? Войти') : ((t as any).auth ? (t as any).auth.linkToRegister : 'Нет аккаунта? Зарегистрироваться')}
                    </button>
                    {!isRegisterMode && (
