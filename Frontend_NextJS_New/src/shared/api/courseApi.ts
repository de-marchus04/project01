"use server";
// Architecture: Read operations use Prisma (server-side, same DB).
// Write operations (add/update/delete) should migrate to .NET API
// via backendClient.ts once backend schema IDs are aligned.
